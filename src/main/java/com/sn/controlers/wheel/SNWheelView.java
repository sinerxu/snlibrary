package com.sn.controlers.wheel;
...
import com.sn.lib.R;
import com.sn.controlers.wheel.adapter.SNWheelAdapter;
import com.wheel.scroll.WeScrollableView;
import com.wheel.scroll.WeStep;
 ...
 * @since 2013-12-26
 */
public class SNWheelView extends WeScrollableView implements OnClickListener {
    ...
    private SNWheelAdapter adapter;
    ...
    public SNWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        this.textSize = SNWindowUtil.computeScaledSize(textSize);
        ...
        this.lineSplitHeight = SNWindowUtil.computeScaledSize(this.lineSplitHeight);
    ...
    public void setAdapter(SNWheelAdapter adapter) {
    ...
    public void onClick(View v) {
        LinkedList<WeStep> stepList = new LinkedList<WeStep>();
        WeStep step1 = WeStep.createDistanceStep(200, 200, 2000);
        WeStep step2 = WeStep.createDistanceStep(-200, -200);
        WeStep step3 = WeStep.createDistanceStep(200, -200);
        WeStep step4 = WeStep.createDistanceStep(0, 0);
        stepList.add(step1);
        stepList.add(step2);
        stepList.add(step3);
        stepList.add(step4);
    ...
    private void fling() {
        ...
        int duration = WeStep.DEFAULT_DURATION;
