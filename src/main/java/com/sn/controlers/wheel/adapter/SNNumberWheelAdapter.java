package com.sn.controlers.wheel.adapter;

import com.wheel.utils.SNTextUtil;
 ...
 * @since 2013-12-26
 */
public class SNNumberWheelAdapter extends SNWheelAdapter {
    private int startNumber;
    private int endNumber;
    private int interval;
    private String label;

    public SNNumberWheelAdapter(int startNumber, int endNumber, int interval, String label) {
