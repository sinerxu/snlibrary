...
public class SNWindowUtil {
    ...
    private static final String TAG = SNWindowUtil.class.getSimpleName();
    /**
     * 状态栏高度
     */
    ...
    static {
        computeScaleRatio(SNApplication.getAppContext());
        computeScreenDensity(SNApplication.getAppContext());
        computeWindowRotation(SNApplication.getAppContext());
    }
     ...
     * @return 是否成功设置
     */
    public static boolean setWidth(Context context, View view, int designedWidthResId) {
        float designedWidth = context.getResources().getDimension(designedWidthResId);
     ...
     * @return 是否成功设置
     */
    public static boolean setHeight(Context context, View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = context.getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
     ...
     * @return 是否成功设置
     */
    public static boolean setSize(Context context, View view, int designedWidthResId, int designedHeightResId) {
        float designedWidth = context.getResources().getDimension(designedWidthResId);
        float designedHeight = context.getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
     ...
     * @return 是否成功设置
     */
    public static boolean setTextSize(Context context, TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = context.getResources().getDimension(designedTextSizeResId);
     ...
     * @return
     */
    public static float getHorizontalScaledDimen(Context context, int heightResId) {
        return context.getResources().getDimension(heightResId) * SCALE_RATIO_HORIZONTAL;
    }
     ...
     * @return
     */
    public static float getVerticalScaledDimen(Context context, int heightResId) {
        return context.getResources().getDimension(heightResId) * SCALE_RATIO_VERTICAL;
    }
     ...
     * @return
     */
    public static float computeDimen(Context context, int resId) {
     ...
     * @return
     */
    public static float computeScaledDimen(Context context, int resId, float ratio) {
        return computeDimen(context, resId) * ratio;
    }
     ...
     * @return
     */
    public static float computeScaledDimenByVerticalRatio(Context context, int resId) {
        return computeScaledDimen(context, resId, SCALE_RATIO_VERTICAL);
    }
     ...
     * @return
     */
    public static float computeScaledDimenByHorizontalRatio(Context context, int resId) {
        return computeScaledDimen(context, resId, SCALE_RATIO_HORIZONTAL);
    }
