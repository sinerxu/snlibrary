...
public class SNTextUtil {
    ...
    public static String getString(int resId) {
        return SNApplication.getAppContext().getResources().getString(resId);
    }
    ...
    public static String getString(int resId, Object... formatArgs) {
        return SNApplication.getAppContext().getResources().getString(resId, formatArgs);
    }
    ...
    public static void cleanPasswordEditText(final EditText editText, final TextWatcher textWatcher) {
        ...
        password = SNTextUtil.cleanPassword(password);
    ...
    public static String[] getStringArray(int arrayResId) {
        return SNApplication.getAppContext().getResources().getStringArray(arrayResId);
    }
}
